  ...
  <div class="py-2 sm:py-5 flex justify-center overflow-hidden">
    <div container flex flex-col items-center>
      ...
      <ul id="list" gap-y-4 flex flex-col max-w-3xl w-screen px-2 sm:px-4>
        ...
        <li v-for="questionResult in sortedQuestionResults" v-else :key="questionResult.evaluationId" ring ring-gray-400 sm:px-4 px-2 py-4 space-y-4 w-full shadow-md bg-white rounded-md>
